...
const NigeriaStates = [
    { "state": { "name": "Benue State", "id" :1, "locals": [
        ...
        { "name": "Guma", "id" :2, "communities": [{ "name": "Daudu"},{ "name": "Agasha"},{ "name": "Iye"}] },
        { "name": "Gwer East", "id" :3, "communities": [{ "name": "Aliade"},{ "name": "Mbalom"},{ "name": "Mbakyaan"}] },
        { "name": "Gwer West", "id" :4, "communities": [{ "name": "Mbakondu"},{ "name": "Naka"}] },
        { "name": "Kwande", "id" :5, "communities": [{ "name": "Adikpo"},{ "name": "Jato-aka"}] },
        { "name": "Logo", "id" :6, "communities": [{ "name": "Ugondo"},{ "name": "Ugba"}] },
        { "name": "Makurdi", "id" :7, "communities": [{ "name": "Akpehe, makurdi"},{ "name": "Makurdi"}] },
