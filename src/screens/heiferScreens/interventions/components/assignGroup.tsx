...
import { Group, useGetGroupsQuery, useAssignInterventionMutation } from "store/group";
...
export const AssignGroupDialog: React.FC<AssignGroupDialogProps> = ({
  ...
  const [assignGroup] = useAssignInterventionMutation();
  ...
  const initRequest = () => {
    let payload = { group_id: requiredId, interventions: [{ id: values.group }]}
